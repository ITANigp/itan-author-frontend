  ...
  return (
    ...
    >
      ...
      <div className="hidden lg:flex items-center space-x-6 absolute left-1/2 transform -translate-x-1/2">
        ...
        <Link
          href="/blog"
          className={`text-gray-200 px-3 py-2 transition-all duration-200 text-sm font-medium ${blogPath ? "border-b-2 border-b-red-600" : ""} hover:border-b-2 hover:border-b-red-600 hover:text-red-400 cursor-pointer `}
        >
          Blog
        </Link>
        <Link
